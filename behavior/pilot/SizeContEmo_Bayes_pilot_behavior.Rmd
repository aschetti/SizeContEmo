...
```{r main_data}
data.behav <- read.csv(paste0(expphase,"_behavioral_data.csv"),header=TRUE) # load data
...
```{r acc_graph}
# summarize data
# summary.data.Acc <- summarySEwithin(data.behav,"Accuracy",withinvars=c("Cont","Size"),idvar="Participant")
# kable(summary.data.Acc)

# accuracy graph
pirateplot(formula=Accuracy~Cont+Size, # dependent~independent variables
