...
This analysis is based on visual inspection of the waveforms by Antonio.   
...
Time window: 66 - 148 ms   
Electrode cluster: Iz P9 P10 PO7 PO8 P7 O2 P6 P8 TP7 P5 PO4 TP8 P4 CP6   
...
P1.topos.grand.avg.allbins <- summarySEwithin(subset(grand.avg.allbins,timepoint >= 66 & timepoint <= 148),"amplitude",withinvars="electrode")
...
```{r P1_locpeakamp}
P1.locpeakamp <- read.table("P1_locpeakamp_AS.txt",header=TRUE) # load data
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(P1.locpeakamp.sizeplusemo.BF,file=paste0("P1_locpeakamp_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeakamp.sizeplusemo.BF <- readRDS(paste0("P1_locpeakamp_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(P1.locpeakamp.sizebyemo.BF,file=paste0("P1_locpeakamp_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeakamp.sizebyemo.BF <- readRDS(paste0("P1_locpeakamp_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(P1.locpeakamp.contplusemo.BF,file=paste0("P1_locpeakamp_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeakamp.contplusemo.BF <- readRDS(paste0("P1_locpeakamp_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(P1.locpeakamp.contbyemo.BF,file=paste0("P1_locpeakamp_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeakamp.contbyemo.BF <- readRDS(paste0("P1_locpeakamp_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(P1.locpeakamp.sizepluscontplusemo.BF,file=paste0("P1_locpeakamp_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeakamp.sizepluscontplusemo.BF <- readRDS(paste0("P1_locpeakamp_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(P1.locpeakamp.sizebycontbyemo.BF,file=paste0("P1_locpeakamp_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeakamp.sizebycontbyemo.BF <- readRDS(paste0("P1_locpeakamp_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(P1.locpeakamp.size.BF,file=paste0("P1_locpeakamp_size_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeakamp.size.BF <- readRDS(paste0("P1_locpeakamp_size_BF_",scaling.factor[k],"_AS.rds")) # load model
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(P1.locpeakamp.cont.BF,file=paste0("P1_locpeakamp_cont_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeakamp.cont.BF <- readRDS(paste0("P1_locpeakamp_cont_BF_",scaling.factor[k],"_AS.rds")) # load model
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(P1.locpeakamp.emo.BF,file=paste0("P1_locpeakamp_emo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeakamp.emo.BF <- readRDS(paste0("P1_locpeakamp_emo_BF_",scaling.factor[k],"_AS.rds")) # load model
...
```{r P1_locpeaklat}
P1.locpeaklat <- read.table("P1_locpeaklat_AS.txt",header=TRUE) # load data
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(P1.locpeaklat.sizeplusemo.BF,file=paste0("P1_locpeaklat_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeaklat.sizeplusemo.BF <- readRDS(paste0("P1_locpeaklat_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(P1.locpeaklat.sizebyemo.BF,file=paste0("P1_locpeaklat_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeaklat.sizebyemo.BF <- readRDS(paste0("P1_locpeaklat_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(P1.locpeaklat.contplusemo.BF,file=paste0("P1_locpeaklat_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeaklat.contplusemo.BF <- readRDS(paste0("P1_locpeaklat_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(P1.locpeaklat.contbyemo.BF,file=paste0("P1_locpeaklat_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeaklat.contbyemo.BF <- readRDS(paste0("P1_locpeaklat_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(P1.locpeaklat.sizepluscontplusemo.BF,file=paste0("P1_locpeaklat_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeaklat.sizepluscontplusemo.BF <- readRDS(paste0("P1_locpeaklat_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(P1.locpeaklat.sizebycontbyemo.BF,file=paste0("P1_locpeaklat_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeaklat.sizebycontbyemo.BF <- readRDS(paste0("P1_locpeaklat_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(P1.locpeaklat.cont.BF,file=paste0("P1_locpeaklat_cont_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeaklat.cont.BF <- readRDS(paste0("P1_locpeaklat_cont_BF_",scaling.factor[k],"_AS.rds")) # load model
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(P1.locpeaklat.emo.BF,file=paste0("P1_locpeaklat_emo_BF_",scaling.factor[k],"_AS.rds")) # save model
  P1.locpeaklat.emo.BF <- readRDS(paste0("P1_locpeaklat_emo_BF_",scaling.factor[k],"_AS.rds")) # load model
...
Time window: 150 - 260 ms   
Electrode cluster: CP5 TP7 CP6 TP8 P6 P8 P10 T7 P9 T8   
...
```{r N1_locpeakamp}
N1.locpeakamp <- read.table("N1_locpeakamp_AS.txt",header=TRUE) # load data
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(N1.locpeakamp.sizeplusemo.BF,file=paste0("N1_locpeakamp_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeakamp.sizeplusemo.BF <- readRDS(paste0("N1_locpeakamp_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(N1.locpeakamp.sizebyemo.BF,file=paste0("N1_locpeakamp_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeakamp.sizebyemo.BF <- readRDS(paste0("N1_locpeakamp_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(N1.locpeakamp.contplusemo.BF,file=paste0("N1_locpeakamp_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeakamp.contplusemo.BF <- readRDS(paste0("N1_locpeakamp_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(N1.locpeakamp.contbyemo.BF,file=paste0("N1_locpeakamp_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeakamp.contbyemo.BF <- readRDS(paste0("N1_locpeakamp_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(N1.locpeakamp.sizepluscontplusemo.BF,file=paste0("N1_locpeakamp_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeakamp.sizepluscontplusemo.BF <- readRDS(paste0("N1_locpeakamp_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(N1.locpeakamp.sizebycontbyemo.BF,file=paste0("N1_locpeakamp_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeakamp.sizebycontbyemo.BF <- readRDS(paste0("N1_locpeakamp_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(N1.locpeakamp.size.BF,file=paste0("N1_locpeakamp_size_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeakamp.size.BF <- readRDS(paste0("N1_locpeakamp_size_BF_",scaling.factor[k],"_AS.rds")) # load model
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(N1.locpeakamp.cont.BF,file=paste0("N1_locpeakamp_cont_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeakamp.cont.BF <- readRDS(paste0("N1_locpeakamp_cont_BF_",scaling.factor[k],"_AS.rds")) # load model
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(N1.locpeakamp.emo.BF,file=paste0("N1_locpeakamp_emo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeakamp.emo.BF <- readRDS(paste0("N1_locpeakamp_emo_BF_",scaling.factor[k],"_AS.rds")) # load model
...
```{r N1_locpeaklat}
N1.locpeaklat <- read.table("N1_locpeaklat_AS.txt",header=TRUE) # load data
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(N1.locpeaklat.sizeplusemo.BF,file=paste0("N1_locpeaklat_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeaklat.sizeplusemo.BF <- readRDS(paste0("N1_locpeaklat_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(N1.locpeaklat.sizebyemo.BF,file=paste0("N1_locpeaklat_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeaklat.sizebyemo.BF <- readRDS(paste0("N1_locpeaklat_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(N1.locpeaklat.contplusemo.BF,file=paste0("N1_locpeaklat_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeaklat.contplusemo.BF <- readRDS(paste0("N1_locpeaklat_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(N1.locpeaklat.contbyemo.BF,file=paste0("N1_locpeaklat_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeaklat.contbyemo.BF <- readRDS(paste0("N1_locpeaklat_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(N1.locpeaklat.sizepluscontplusemo.BF,file=paste0("N1_locpeaklat_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeaklat.sizepluscontplusemo.BF <- readRDS(paste0("N1_locpeaklat_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(N1.locpeaklat.sizebycontbyemo.BF,file=paste0("N1_locpeaklat_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeaklat.sizebycontbyemo.BF <- readRDS(paste0("N1_locpeaklat_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(N1.locpeaklat.size.BF,file=paste0("N1_locpeaklat_size_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeaklat.size.BF <- readRDS(paste0("N1_locpeaklat_size_BF_",scaling.factor[k],"_AS.rds")) # load model
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(N1.locpeaklat.cont.BF,file=paste0("N1_locpeaklat_cont_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeaklat.cont.BF <- readRDS(paste0("N1_locpeaklat_cont_BF_",scaling.factor[k],"_AS.rds")) # load model
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(N1.locpeaklat.emo.BF,file=paste0("N1_locpeaklat_emo_BF_",scaling.factor[k],"_AS.rds")) # save model
  N1.locpeaklat.emo.BF <- readRDS(paste0("N1_locpeaklat_emo_BF_",scaling.factor[k],"_AS.rds")) # load model
...
ggplot(subset(comps.grand.avg.allbins,component=="EPN" & bin!="all"),aes(timepoint,amplitude)) + # basic plot
  geom_line(aes(color=bin),size=1.5,alpha=.6) + # one line per bin
  scale_colour_brewer(palette="Dark2") + # color palette
  labs(title="EPN (280 - 402 ms)",x="time (ms)",y=expression(paste("amplitude (",mu,"V)"))) + # title & axes labels
  scale_x_continuous(breaks=seq(-200,1000,50),limits=c(-100,500)) + # x-axis: tick marks
  scale_y_reverse(breaks=seq(-3,3,1),limits=c(3,-3)) + # y-axis: tick marks
  geom_vline(xintercept=0,linetype="dashed",colour="black",size=.8,alpha=.8) + # vertical reference line
  geom_hline(yintercept=0,linetype="dashed",colour="black",size=.8,alpha=.8) + # horizontal reference line
  annotate("rect",xmin=280,xmax=402,ymin=-1,ymax=1.5,alpha=.2) + # highlight time window used for analysis
...
```{r EPN_locpeakamp}
EPN.locpeakamp <- read.table("EPN_locpeakamp_AS.txt",header=TRUE) # load data
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(EPN.locpeakamp.sizeplusemo.BF,file=paste0("EPN_locpeakamp_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  EPN.locpeakamp.sizeplusemo.BF <- readRDS(paste0("EPN_locpeakamp_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(EPN.locpeakamp.sizebyemo.BF,file=paste0("EPN_locpeakamp_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  EPN.locpeakamp.sizebyemo.BF <- readRDS(paste0("EPN_locpeakamp_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(EPN.locpeakamp.contplusemo.BF,file=paste0("EPN_locpeakamp_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  EPN.locpeakamp.contplusemo.BF <- readRDS(paste0("EPN_locpeakamp_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(EPN.locpeakamp.contbyemo.BF,file=paste0("EPN_locpeakamp_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  EPN.locpeakamp.contbyemo.BF <- readRDS(paste0("EPN_locpeakamp_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(EPN.locpeakamp.sizepluscontplusemo.BF,file=paste0("EPN_locpeakamp_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  EPN.locpeakamp.sizepluscontplusemo.BF <- readRDS(paste0("EPN_locpeakamp_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(EPN.locpeakamp.sizebycontbyemo.BF,file=paste0("EPN_locpeakamp_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  EPN.locpeakamp.sizebycontbyemo.BF <- readRDS(paste0("EPN_locpeakamp_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
...
```{r EPN_locpeaklat}
EPN.locpeaklat <- read.table("EPN_locpeaklat_AS.txt",header=TRUE) # load data
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(EPN.locpeaklat.sizeplusemo.BF,file=paste0("EPN_locpeaklat_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  EPN.locpeaklat.sizeplusemo.BF <- readRDS(paste0("EPN_locpeaklat_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(EPN.locpeaklat.sizebyemo.BF,file=paste0("EPN_locpeaklat_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  EPN.locpeaklat.sizebyemo.BF <- readRDS(paste0("EPN_locpeaklat_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(EPN.locpeaklat.contplusemo.BF,file=paste0("EPN_locpeaklat_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  EPN.locpeaklat.contplusemo.BF <- readRDS(paste0("EPN_locpeaklat_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(EPN.locpeaklat.contbyemo.BF,file=paste0("EPN_locpeaklat_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  EPN.locpeaklat.contbyemo.BF <- readRDS(paste0("EPN_locpeaklat_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(EPN.locpeaklat.sizepluscontplusemo.BF,file=paste0("EPN_locpeaklat_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  EPN.locpeaklat.sizepluscontplusemo.BF <- readRDS(paste0("EPN_locpeaklat_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(EPN.locpeaklat.sizebycontbyemo.BF,file=paste0("EPN_locpeaklat_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  EPN.locpeaklat.sizebycontbyemo.BF <- readRDS(paste0("EPN_locpeaklat_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
...
Time window: 402 - 1000 ms   
Electrode cluster: P5 P3 PO3 P1 Pz POz P2 P4 PO4 P6 PO8 CP6 P8 CP5 TP8 CP3 CP4 CP1 CP2 CPz C5 C3 C4   
...
ggplot(subset(comps.grand.avg.allbins,component=="LPP" & bin!="all"),aes(timepoint,amplitude)) + # basic plot
  ...
  geom_vline(xintercept=0,linetype="dashed",colour="black",size=.8,alpha=.8) + # vertical reference line
  geom_hline(yintercept=0,linetype="dashed",colour="black",size=.8,alpha=.8) + # horizontal reference line
  annotate("rect",xmin=402,xmax=1000,ymin=-.5,ymax=1.5,alpha=.2) + # highlight time window used for analysis
  theme_pander(base_size=20,pc="white",lp=c(.8,.8)) # custom theme
```
...
```{r LPP_meanamp}
LPP.meanamp <- read.table("LPP_meanamp_AS.txt",header=TRUE) # load data
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  # saveRDS(LPP.meanamp.sizeplusemo.BF,file=paste0("LPP_meanamp_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  LPP.meanamp.sizeplusemo.BF <- readRDS(paste0("LPP_meanamp_sizeplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(LPP.meanamp.sizebyemo.BF,file=paste0("LPP_meanamp_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  LPP.meanamp.sizebyemo.BF <- readRDS(paste0("LPP_meanamp_sizebyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(LPP.meanamp.contplusemo.BF,file=paste0("LPP_meanamp_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  LPP.meanamp.contplusemo.BF <- readRDS(paste0("LPP_meanamp_contplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(LPP.meanamp.contbyemo.BF,file=paste0("LPP_meanamp_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  LPP.meanamp.contbyemo.BF <- readRDS(paste0("LPP_meanamp_contbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(LPP.meanamp.sizepluscontplusemo.BF,file=paste0("LPP_meanamp_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  LPP.meanamp.sizepluscontplusemo.BF <- readRDS(paste0("LPP_meanamp_sizepluscontplusemo_BF_",scaling.factor[k],"_AS.rds")) # load model
  ...
  # saveRDS(LPP.meanamp.sizebycontbyemo.BF,file=paste0("LPP_meanamp_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # save model
  LPP.meanamp.sizebycontbyemo.BF <- readRDS(paste0("LPP_meanamp_sizebycontbyemo_BF_",scaling.factor[k],"_AS.rds")) # load model
