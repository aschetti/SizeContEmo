...
# load topographies
topos <- read_csv(here::here("EEG/main/main_topoEEG.csv")) %>%
...
Exploratory analyses further suggest that omitting *emotion* from the full model improves fitting by `r compare.N1.anovaBF$med[1]` times. Removing *size x emotion*, *contrast x emotion*, and *size x contrast x emotion* also improves fitting by `r compare.N1.anovaBF$med[2]`, `r compare.N1.anovaBF$med[3]`, and `r compare.N1.anovaBF$med[4]` times, respectively.   
...
#   )
# 
#   saveRDS(EPN.posthocBF.large.dark.negVSneut,
...
#   )
# 
#   saveRDS(LPP.posthocBF.large.dark.negVSneut,
...
```{r data_peaks}
# load data
data.P1.peakamp <- read.table(here::here(paste0("EEG/main/P1_locpeakamp.txt")), header = TRUE)
data.P1.peaklat <- read.table(here::here(paste0("EEG/main/P1_locpeaklat.txt")), header = TRUE)
data.N1.peakamp <- read.table(here::here(paste0("EEG/main/N1_locpeakamp.txt")), header = TRUE)
data.N1.peaklat <- read.table(here::here(paste0("EEG/main/N1_locpeaklat.txt")), header = TRUE)
...
# summarize data
summary.P1.peakamp <- summarySEwithin(subset(data.peaks, component == "P1" & var == "peak.amp"), 
                                      "value", 
...
P1.peakamp.posthocBF <- subset(data.peaks, component == "P1" & var == "peak.amp") %>%
...
summary.P1.peaklat <- summarySEwithin(subset(data.peaks, component == "P1" & var == "peak.lat"), 
                                      "value", 
                                      withinvars = c("size", "cont", "emo", "visualfeats"), 
                                      idvar = "participant")
...
P1.peaklat.posthocBF <- subset(data.peaks, component == "P1" & var == "peak.lat") %>%
  select(participant, condition, value) %>%
  split(.$condition)
...
summary.N1.peakamp <- summarySEwithin(subset(data.peaks, component == "N1" & var == "peak.amp"), 
                                      "value", 
                                      withinvars = c("size", "cont", "emo", "visualfeats"), 
                                      idvar = "participant")
...
N1.peakamp.posthocBF <- subset(data.peaks, component == "N1" & var == "peak.amp") %>%
  select(participant, condition, value) %>%
  split(.$condition)
...
summary.N1.peaklat <- summarySEwithin(subset(data.peaks, component == "N1" & var == "peak.lat"), 
                                      "value", 
                                      withinvars = c("size", "cont", "emo", "visualfeats"), 
                                      idvar = "participant")
...
N1.peaklat.posthocBF <- subset(data.peaks, component == "N1" & var == "peak.lat") %>%
  select(participant, condition, value) %>%
  split(.$condition)
