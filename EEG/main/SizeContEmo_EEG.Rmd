...
P1.posthocBF.size <- data.EEG.trial %>% # data frame
  select(participant,size,word,P1) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="P1",withinvars=c("participant","size"),idvar="word") %>% # summary
  split(.$size) # split according to condition
# contrast
P1.posthocBF.cont <- data.EEG.trial %>% # data frame
  select(participant,cont,word,P1) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="P1",withinvars=c("participant","cont"),idvar="word") %>% # summary
  split(.$cont) # split according to condition
# emotion
P1.posthocBF.emo <- data.EEG.trial %>% # data frame
  select(participant,emo,word,P1) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="P1",withinvars=c("participant","emo"),idvar="word") %>% # summary
...
P1.posthocBF <- data.EEG.trial %>% # data frame
  select(participant,condition,word,P1) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="P1",withinvars=c("participant","condition"),idvar="word") %>% # summary
...
N1.posthocBF.size <- data.EEG.trial %>% # data frame
  select(participant,size,word,N1) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="N1",withinvars=c("participant","size"),idvar="word") %>% # summary
  split(.$size) # split according to condition
# contrast
N1.posthocBF.cont <- data.EEG.trial %>% # data frame
  select(participant,cont,word,N1) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="N1",withinvars=c("participant","cont"),idvar="word") %>% # summary
  split(.$cont) # split according to condition
# emotion
N1.posthocBF.emo <- data.EEG.trial %>% # data frame
  select(participant,emo,word,N1) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="N1",withinvars=c("participant","emo"),idvar="word") %>% # summary
  split(.$emo) # split according to condition

# interactions of interest (i.e., always negative vs. neutral)
N1.posthocBF <- data.EEG.trial %>% # data frame
  select(participant,condition,word,N1) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="N1",withinvars=c("participant","condition"),idvar="word") %>% # summary
  split(.$condition) # split according to condition
...
EPN.posthocBF.size <- data.EEG.trial %>% # data frame
  select(participant,size,word,EPN) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="EPN",withinvars=c("participant","size"),idvar="word") %>% # summary
  split(.$size) # split according to condition
# contrast
EPN.posthocBF.cont <- data.EEG.trial %>% # data frame
  select(participant,cont,word,EPN) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="EPN",withinvars=c("participant","cont"),idvar="word") %>% # summary
  split(.$cont) # split according to condition
# emotion
EPN.posthocBF.emo <- data.EEG.trial %>% # data frame
  select(participant,emo,word,EPN) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="EPN",withinvars=c("participant","emo"),idvar="word") %>% # summary
  split(.$emo) # split according to condition

# interactions of interest (i.e., always negative vs. neutral)
EPN.posthocBF <- data.EEG.trial %>% # data frame
  select(participant,condition,word,EPN) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="EPN",withinvars=c("participant","condition"),idvar="word") %>% # summary
  split(.$condition) # split according to condition
...
LPP.posthocBF.size <- data.EEG.trial %>% # data frame
  select(participant,size,word,LPP) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="LPP",withinvars=c("participant","size"),idvar="word") %>% # summary
  split(.$size) # split according to condition
# contrast
LPP.posthocBF.cont <- data.EEG.trial %>% # data frame
  select(participant,cont,word,LPP) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="LPP",withinvars=c("participant","cont"),idvar="word") %>% # summary
  split(.$cont) # split according to condition
# emotion
LPP.posthocBF.emo <- data.EEG.trial %>% # data frame
  select(participant,emo,word,LPP) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="LPP",withinvars=c("participant","emo"),idvar="word") %>% # summary
  split(.$emo) # split according to condition

# interactions of interest (i.e., always negative vs. neutral)
LPP.posthocBF <- data.EEG.trial %>% # data frame
  select(participant,condition,word,LPP) %>% # select only variables of interest
  summarySEwithin(data=.,measurevar="LPP",withinvars=c("participant","condition"),idvar="word") %>% # summary
  split(.$condition) # split according to condition
...
Visual inspection of the waveforms revealed unexpected latency shifts
