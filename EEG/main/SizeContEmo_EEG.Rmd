...
opts_chunk$set(warning=FALSE, # no package warnings
...
grand.avg.topos <- read.csv(paste0(expphase, "_topoEEG.csv"), # load data
                            header=TRUE, 
                            check.names=FALSE) # eliminate the "X" at the beginning of each timepoint
...
```{r graph_grandavg}
grand.avg.localizer <- read.csv(paste0(expphase, "_grandEEG_localizer.csv"), # load data
                                header=TRUE, 
                                check.names=FALSE) # eliminate the "X" at the beginning of each timepoint
...
ggplot(grand.avg.localizer.pointsummary, aes(x=timepoint, y=amplitude, group=electrode)) + # basic plot
  ...
  geom_vline(xintercept=seq(-200, 1000, 100), linetype="dotted", color="#999999", size=.8, alpha=.5) + # reference lines
  geom_hline(yintercept=seq(-3, 3, 1), linetype="dotted", color="#999999", size=.8, alpha=.5) + # reference lines
  theme_pander(base_size=20, pc="white", lp="none") # custom theme
```

```{r data_grandavg_comps}
grand.avg.comps <- read.csv(paste0(expphase, "_avgERP.csv"), # load data
                            header=TRUE, 
                            check.names=FALSE) # eliminate the "X" at the beginning of each timepoint
...
P1.grand.avg.comps.pointsummary <- grand.avg.comps %>% # data frame
  ...
  summarySEwithin(data=., # summary
                  measurevar="amplitude", 
                  withinvars=c("condition", "timepoint"), 
                  idvar="participant") %>%
  mutate(timepoint=as.numeric(levels(timepoint))[timepoint]) # re-convert time points to numeric
...
ggplot(filter(P1.grand.avg.comps.pointsummary, condition!="localizer"), aes(x=timepoint, y=amplitude, group=condition, color=condition)) + # basic plot
  ...
  geom_vline(xintercept=0, linetype="dashed", color="black", size=1.2, alpha=.8) + # vertical reference line
  geom_hline(yintercept=0, linetype="dashed", color="black", size=1.2, alpha=.8) + # horizontal reference line
  geom_vline(xintercept=seq(-200, 1000, 50), linetype="dotted", color="#999999", size=.8, alpha=.5) + # reference lines
  geom_hline(yintercept=seq(-3, 3, 1), linetype="dotted", color="#999999", size=.8, alpha=.5) + # reference lines
  ...
  # guides(color=FALSE) + # delete legend
...
compare.P1.BF <- matrix(NA, 6, length(scaling.factor)) # BFs
compare.P1.perc.err <- matrix(NA, 6, length(scaling.factor)) # % errors
...
P1.posthocBF <- data.EEG.trial %>% # data frame
  select(participant, cond, P1) %>% # select only variables of interest
  summarySEwithin(data=., measurevar="P1", withinvars=c("participant", "cond")) %>% # summary
  split(.$cond) # split according to condition

compare.P1.posthocBF <- matrix(NA, 4, length(scaling.factor)) # preallocate matrix with all BF10
compare.P1.posthocBF.perc.err <- matrix(NA, 4, length(scaling.factor)) # preallocate matrix with all % errors

for(k in 1:length(scaling.factor)) { # loop through scaling factors

  # large, dark, negative vs. neutral
  # P1.posthocBF.large.dark.negVSneut <- ttestBF(P1.posthocBF$`negative large dark`$P1, # first condition
  ...
  # P1.posthocBF.small.dark.negVSneut <- ttestBF(P1.posthocBF$`negative small dark`$P1, # first condition
  #                                              P1.posthocBF$`neutral small dark`$P1, # second condition
  #                                              mu=0, # null hypothesis (mean difference=0)
  #                                              paired=TRUE, # paired sample test
  #                                              iterations=niter, # number of MCMC iterations
  #                                              rscale=scaling.factor[k]) # scaling factor
  ...
  # P1.posthocBF.large.bright.negVSneut <- ttestBF(P1.posthocBF$`negative large bright`$P1, # first condition
  #                                                P1.posthocBF$`neutral large bright`$P1, # second condition
  #                                                mu=0, # null hypothesis (mean difference=0)
  #                                                paired=TRUE, # paired sample test
  #                                                iterations=niter, # number of MCMC iterations
  #                                                rscale=scaling.factor[k]) # scaling factor
  ...
  # P1.posthocBF.small.bright.negVSneut <- ttestBF(P1.posthocBF$`negative small bright`$P1, # first condition
  #                                                P1.posthocBF$`neutral small bright`$P1, # second condition
  #                                                mu=0, # null hypothesis (mean difference=0)
  #                                                iterations=niter, # number of MCMC iterations
  #                                                paired=TRUE, # paired sample test
  #                                                rscale=scaling.factor[k]) # scaling factor
  ...
  ### model comparison
  compare.P1.posthocBF[, k] <- c(exp(P1.posthocBF.large.dark.negVSneut@bayesFactor$bf[1]), 
  ...
  # percentage of error
  compare.P1.posthocBF.perc.err[, k] <- c(P1.posthocBF.large.dark.negVSneut@bayesFactor$error[1]*100, 
...
# summary
compare.P1.posthocBF <- data.frame("comparison"=c("large.dark.negVSneut", "small.dark.negVSneut", "large.bright.negVSneut", "small.bright.negVSneut"), 
...
# preallocate matrices with all BFs
compare.P1.anovaBF.temp <- matrix(NA, 7, length(scaling.factor)) # BFs
compare.P1.anovaBF.perc.err.temp <- matrix(NA, 7, length(scaling.factor)) # % errors
...
compare.P1.anovaBF <- compare.P1.anovaBF[order(compare.P1.anovaBF$med, decreasing=TRUE), ] # sort according to medium scaling factor (in descending order)
...
```{r N1_models}
# preallocate matrices with all BFs
compare.N1.BF <- matrix(NA, 6, length(scaling.factor)) # BFs
compare.N1.perc.err <- matrix(NA, 6, length(scaling.factor)) # % errors
...
N1.posthocBF <- data.EEG.trial %>% # data frame
  select(participant, cond, N1) %>% # select only variables of interest
  summarySEwithin(data=., measurevar="N1", withinvars=c("participant", "cond")) %>% # summary
  split(.$cond) # split according to condition

compare.N1.posthocBF <- matrix(NA, 4, length(scaling.factor)) # preallocate matrix with all BF10
compare.N1.posthocBF.perc.err <- matrix(NA, 4, length(scaling.factor)) # preallocate matrix with all % errors

for(k in 1:length(scaling.factor)) { # loop through scaling factors

  # large, dark, negative vs. neutral
  # N1.posthocBF.large.dark.negVSneut <- ttestBF(N1.posthocBF$`negative large dark`$N1, # first condition
  ...
  # small, dark, negative vs. neutral
  # N1.posthocBF.small.dark.negVSneut <- ttestBF(N1.posthocBF$`negative small dark`$N1, # first condition
  #                                              N1.posthocBF$`neutral small dark`$N1, # second condition
  #                                              mu=0, # null hypothesis (mean difference=0)
  #                                              paired=TRUE, # paired sample test
  #                                              iterations=niter, # number of MCMC iterations
  #                                              rscale=scaling.factor[k]) # scaling factor
  ...
  # large, bright, negative vs. neutral
  # N1.posthocBF.large.bright.negVSneut <- ttestBF(N1.posthocBF$`negative large bright`$N1, # first condition
  #                                                N1.posthocBF$`neutral large bright`$N1, # second condition
  #                                                mu=0, # null hypothesis (mean difference=0)
  #                                                paired=TRUE, # paired sample test
  #                                                iterations=niter, # number of MCMC iterations
  #                                                rscale=scaling.factor[k]) # scaling factor
  ...
  # small, bright, negative vs. neutral
  # N1.posthocBF.small.bright.negVSneut <- ttestBF(N1.posthocBF$`negative small bright`$N1, # first condition
  #                                                N1.posthocBF$`neutral small bright`$N1, # second condition
  #                                                mu=0, # null hypothesis (mean difference=0)
  #                                                iterations=niter, # number of MCMC iterations
  #                                                paired=TRUE, # paired sample test
  #                                                rscale=scaling.factor[k]) # scaling factor
  ...
  ### model comparison
  compare.N1.posthocBF[, k] <- c(exp(N1.posthocBF.large.dark.negVSneut@bayesFactor$bf[1]), 
  ...
  # percentage of error
  compare.N1.posthocBF.perc.err[, k] <- c(N1.posthocBF.large.dark.negVSneut@bayesFactor$error[1]*100, 
...
# summary
compare.N1.posthocBF <- data.frame("comparison"=c("large.dark.negVSneut", "small.dark.negVSneut", "large.bright.negVSneut", "small.bright.negVSneut"), 
...
# preallocate matrices with all BFs
compare.N1.anovaBF.temp <- matrix(NA, 7, length(scaling.factor)) # BFs
compare.N1.anovaBF.perc.err.temp <- matrix(NA, 7, length(scaling.factor)) # % errors
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  ### model comparison
  compare.EPN.posthocBF[, k] <- c(exp(EPN.posthocBF.large.dark.negVSneut@bayesFactor$bf[1]), 
  ...
  # percentage of error
  compare.EPN.posthocBF.perc.err[, k] <- c(EPN.posthocBF.large.dark.negVSneut@bayesFactor$error[1]*100, 
...
# summary
compare.EPN.posthocBF <- data.frame("comparison"=c("large.dark.negVSneut", "small.dark.negVSneut", "large.bright.negVSneut", "small.bright.negVSneut"), 
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  ### model comparison
  compare.LPP.posthocBF[, k] <- c(exp(LPP.posthocBF.large.dark.negVSneut@bayesFactor$bf[1]), 
  ...
  # percentage of error
  compare.LPP.posthocBF.perc.err[, k] <- c(LPP.posthocBF.large.dark.negVSneut@bayesFactor$error[1]*100, 
...
# summary
compare.LPP.posthocBF <- data.frame("comparison"=c("large.dark.negVSneut", "small.dark.negVSneut", "large.bright.negVSneut", "small.bright.negVSneut"), 
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  ### model comparison
  compare.P1.peakamp.posthocBF[, k] <- c(exp(P1.peakamp.posthocBF.large.dark.negVSneut@bayesFactor$bf[1]), 
  ...
  # percentage of error
  compare.P1.peakamp.posthocBF.perc.err[, k] <- c(P1.peakamp.posthocBF.large.dark.negVSneut@bayesFactor$error[1]*100,
...
# summary
compare.P1.peakamp.posthocBF <- data.frame("comparison"=c("large.dark.negVSneut", "small.dark.negVSneut", "large.bright.negVSneut", "small.bright.negVSneut"), 
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  ### model comparison
  compare.P1.peaklat.posthocBF[, k] <- c(exp(P1.peaklat.posthocBF.large.dark.negVSneut@bayesFactor$bf[1]), 
  ...
  # percentage of error
  compare.P1.peaklat.posthocBF.perc.err[, k] <- c(P1.peaklat.posthocBF.large.dark.negVSneut@bayesFactor$error[1]*100,
...
# summary
compare.P1.peaklat.posthocBF <- data.frame("comparison"=c("large.dark.negVSneut", "small.dark.negVSneut", "large.bright.negVSneut", "small.bright.negVSneut"), 
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  ### model comparison
  compare.N1.peakamp.posthocBF[, k] <- c(exp(N1.peakamp.posthocBF.large.dark.negVSneut@bayesFactor$bf[1]), 
  ...
  # percentage of error
  compare.N1.peakamp.posthocBF.perc.err[, k] <- c(N1.peakamp.posthocBF.large.dark.negVSneut@bayesFactor$error[1]*100,
...
# summary
compare.N1.peakamp.posthocBF <- data.frame("comparison"=c("large.dark.negVSneut", "small.dark.negVSneut", "large.bright.negVSneut", "small.bright.negVSneut"), 
...
for(k in 1:length(scaling.factor)) { # loop through scaling factors
  ...
  ### model comparison
  compare.N1.peaklat.posthocBF[, k] <- c(exp(N1.peaklat.posthocBF.large.dark.negVSneut@bayesFactor$bf[1]), 
  ...
  # percentage of error
  compare.N1.peaklat.posthocBF.perc.err[, k] <- c(N1.peaklat.posthocBF.large.dark.negVSneut@bayesFactor$error[1]*100,
...
# summary
compare.N1.peaklat.posthocBF <- data.frame("comparison"=c("large.dark.negVSneut", "small.dark.negVSneut", "large.bright.negVSneut", "small.bright.negVSneut"), 
